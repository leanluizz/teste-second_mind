...
export default function AutoCarousel({ imgOne, imgTwo, imgThree, imgFour, imgFive, imgSix, imgSeven, imgEight, imgNine, imgTen, imgEleven, imgTwelve }) {
  const [currentIndex, setCurrentIndex] = useState(0);

  const items = [imgOne, imgTwo, imgThree, imgFour, imgFive, imgSix, imgSeven, imgEight, imgNine, imgTen, imgEleven, imgTwelve];

  //Função de evento do carousel
  useEffect(() => {
