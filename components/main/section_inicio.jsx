...
<div className="relative w-full h-screen">
  ...
  <div className="absolute inset-0 flex flex-col items-start justify-center space-y-8 p-5">
    ...
    <Link href="/servicos"><button className="cursor-pointer ml-12 rounded-lg shadow-lg shadow-zinc-900 bg-gradient-to-b from-yellow-300 to-yellow-600 p-2 font-bold text-base animate__animated animate__fadeIn animate__delay-1s	1s"> Solicitar serviços</button></Link>
  </div>
</div>
)
}