    ...
    const ApiComponent = () => {
        return (
            <div>
                ...
                <button className='p-3 bg-gradient-to-b from-yellow-600 via-yellow-500 to bg-yellow-400 font-bold rounded-lg shadow-lg shadow-zinc-900 m-3'>Agendar</button>
            </div>
        );
    }
